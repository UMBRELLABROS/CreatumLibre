...
class ColorAdjustmentDialog(tk.Toplevel):
    """Dialog for adjusting color settings such as brightness, contrast, and saturation of an image."""
    def __init__(self, parent, frame, selection):
        super().__init__(parent.root)
        self.parent = parent
        self.frame = frame
        self.image_data = frame.image_data  
        self.current_tk_size = (self.image_data.tk.width(), self.image_data.tk.height())  # avoid rescale
